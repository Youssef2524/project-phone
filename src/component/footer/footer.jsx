...
const Footer = () => {
    return (
        <Container>
            <footer className="bg-white by-4 mt-3 mb-3 m-lr-5">
                <div className="row">
                    <div
                        className="col-lg-10 col-md-12 d-flex justify-content-lg-start justify-content-md-center justify-content-sm-center">
                        <p className="m-0 fs-xl mt-auto align-items-center m-right-left-2 fw-bolder">
                            © 2023 , <span className="hov"> Phono (password: buddha) </span> <span className="hov">Design Themes</span>
                        </p>
                    </div>

                    <div className="col-lg-2 col-md-12 d-flex justify-content-lg-end justify-content-sm-center ">
                        ...
                        <div className="px-1">
                            <svg className="icon icon--full-color" xmlns="http://www.w3.org/2000/svg" role="img"
                        ...
                        {/* Repeat the same pattern for other payment icons */}
                    </div>
                </div>
            </footer>
        </Container>
